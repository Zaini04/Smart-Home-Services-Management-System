...
import { getMyConversations, getUnreadCount } from '../../src/api/chatEndPoints';
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.chatTop}>
          <Text style={styles.chatName} numberOfLines={1}>{item.otherUser?.name || item.otherUser?.full_name || 'User'}</Text>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Chat with your service providers</Text>
      </View>
