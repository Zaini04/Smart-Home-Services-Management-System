              ...
              {filtered.map((job) => {
                ...
                return (
                  <Link
                    ...
                    className="block bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all"
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="w-16 h-16 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0">
                        {job.images?.[0] ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <FaClipboardList className="w-7 h-7 text-gray-400" />
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-medium text-gray-800 line-clamp-1 text-sm mb-1">
                          {job.description}
                        </p>
