// src/pages/provider/CompleteProfile.jsx
...
import {
  ...
  FaTimesCircle, FaCalendarAlt, FaSpinner, FaSignOutAlt,
} from "react-icons/fa";
import {
  completeProfile,
...
export default function CompleteProfile() {
  ...
  const toggleCategory = (id) => {
    ...
    const skills   = relevant.flatMap((c) =>
      (c.subCategories || []).filter((s) => s._id && isValidObjectId(s._id))
    );
  ...
  /* Progress */
  const progressItems = [
    age, bio, cnic, experience, visitPrice, hourlyRate,
  ...
  const progress = Math.round(
    (progressItems.filter(Boolean).length / progressItems.length) * 100
  );

  return (
    /* 
      Standalone page — full page scroll, own header.
      No layout sidebar since KYC not done yet.
    */
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Step 1 of 2 — Profile Setup</p>
            </div>
          </div>
          <button
            type="button"
            ...
            className="flex items-center gap-2 text-red-500 hover:text-red-600 text-sm
                       font-medium px-3 py-2 rounded-xl hover:bg-red-50 transition-colors"
          >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-gray-200
                          rounded-full px-4 py-1.5 mt-3 shadow-sm">
            <div className={`w-2 h-2 rounded-full ${
              progress === 100 ? "bg-green-500" : "bg-blue-500 animate-pulse"
            }`} />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                placeholder="Describe your experience, specialties, and why customers should choose you..."
          ...
          {availableSkills.length > 0 && (
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-400 text-xs mb-5">
                Select specific skills from your chosen categories
              </p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-400 text-xs mb-5">
              Upload clear photos of both sides of your CNIC for verification
            </p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            >
              {loading ? (
                <><FaSpinner className="w-5 h-5 animate-spin" /> Submitting...</>
              ) : (
                <><FaCheckCircle className="w-5 h-5" /> Submit Profile for Review</>
              )}
            </button>
