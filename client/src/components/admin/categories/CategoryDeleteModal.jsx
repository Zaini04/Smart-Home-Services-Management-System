...
const CategoryDeleteModal = ({ category, onClose, onConfirm, loading }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-scaleIn text-center">
      ...
      <p className="text-gray-500 mb-6">
        Are you sure you want to delete <span className="font-bold text-gray-800">"{category?.name}"</span>?
        This will hide all associated subcategories as well.
      </p>
